...
GEMINI_API_KEY = 'AIzaSyB-624IR8F-0EHKXmi-LlrP_yYt6n7P_68'  # Replace with your valid API key
...
st.markdown(
    """
    <style>
    /* Apply sky blue background to the main app container */
    .stApp {
...
# Main Title
st.markdown('<div class="main-title"> Vision AI 👁️🖋️🔊</div>', unsafe_allow_html=True)

# Sidebar Features
st.sidebar.image(
    r"C:\Users\jadha\Generative AI\GCP\praject_file\computer.png",
    width=250
)
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Credits: Aishwarya | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
